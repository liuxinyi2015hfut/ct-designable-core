...
var Viewport = /** @class */ (function () {
    ...
    Viewport.prototype.attachEvents = function () {
        ...
        shared_1.cancelIdle(this.attachRequest);
        this.attachRequest = shared_1.requestIdle(function () {
            if (!engine)
                return;
            if (_this.isIframe) {
                _this.workspace.attachEvents(_this.contentWindow, _this.contentWindow);
            }
            else if (shared_1.isHTMLElement(_this.viewportElement)) {
    ...
    Viewport.prototype.isPointInViewport = function (point, sensitive) {
        ...
        if (!this.containsElement(document.elementFromPoint(point.x, point.y)))
            return false;
        return shared_1.isPointInRect(point, this.rect, sensitive);
    };
    ...
    Viewport.prototype.isOffsetPointInViewport = function (point, sensitive) {
        ...
        if (!this.containsElement(document.elementFromPoint(point.x, point.y)))
            return false;
        return shared_1.isPointInRect(point, this.innerRect, sensitive);
    };
    ...
    Viewport.prototype.getElementRectById = function (id) {
        ...
        var rect = shared_1.calcBoundingRect(elements.map(function (element) { return _this.getElementRect(element); }));
        if (rect) {
            if (this.isIframe) {
                return (typeof DOMRect !== 'undefined' &&
    ...
    Viewport.prototype.getElementOffsetRectById = function (id) {
        ...
        if (!elements.length)
            return;
        var elementRect = shared_1.calcBoundingRect(elements.map(function (element) { return _this.getElementRect(element); }));
        if (elementRect) {
            if (this.isIframe) {
                return (typeof DOMRect !== 'undefined' &&
    ...
    Viewport.prototype.getChildrenRect = function (node) {
        ...
        if (!((_a = node === null || node === void 0 ? void 0 : node.children) === null || _a === void 0 ? void 0 : _a.length))
            return;
        return shared_1.calcBoundingRect(node.children.reduce(function (buf, child) {
    ...
    Viewport.prototype.getValidNodeRect = function (node) {
        ...
        if (node && node === node.root) {
            if (!rect)
                return this.rect;
            return shared_1.calcBoundingRect([this.rect, rect]);
        }
        if (rect) {
            return rect;
        }
    ...
    Viewport.prototype.getValidNodeOffsetRect = function (node) {
        ...
        if (node && node === node.root) {
            ...
            return shared_1.calcBoundingRect([this.innerRect, rect]);
        }
        if (rect) {
            return rect;
        }
    ...
    Viewport.prototype.getValidNodeLayout = function (node) {
        ...
        if ((_b = (_a = node.parent) === null || _a === void 0 ? void 0 : _a.designerProps) === null || _b === void 0 ? void 0 : _b.inlineChildrenLayout)
            return 'horizontal';
        return shared_1.calcElementLayout(this.findElementById(node.id));
    };
    return Viewport;
}());
