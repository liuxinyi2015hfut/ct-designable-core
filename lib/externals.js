...
var isBehaviorHost = function (val) {
    return (val === null || val === void 0 ? void 0 : val.Behavior) && exports.isBehaviorList(val.Behavior);
};
...
var isResourceHost = function (val) {
    return (val === null || val === void 0 ? void 0 : val.Resource) && exports.isResourceList(val.Resource);
};
...
var createLocales = function () {
    ...
    packages.forEach(function (locales) {
        internals_1.mergeLocales(results, locales);
    });
    return results;
};
...
var createBehavior = function () {
    ...
    return behaviors.reduce(function (buf, behavior) {
        if (shared_1.isArr(behavior))
            return buf.concat(exports.createBehavior.apply(void 0, __spread(behavior)));
...
var createDesigner = function (props) {
    ...
    return reactive_1.untracked(function () {
        return new models_1.Engine(__assign(__assign({}, props), { effects: __spread(effects, presets_1.DEFAULT_EFFECTS), drivers: __spread(drivers, presets_1.DEFAULT_DRIVERS), shortcuts: __spread(shortcuts, presets_1.DEFAULT_SHORTCUTS) }));
    });
};
